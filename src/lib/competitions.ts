...
export const COMPETITIONS: Competition[] = [
  ...
  { name: "Sumo Bot", category: "Robotics", description: "High-torque combat in the ring.", teamSize: "1–4", age: "OTA" },
  ...
  { name: "Aeromodelling Racing", category: "Aerospace", description: "RC aircraft head-to-head time trials.", levels: ["Junior", "Senior"], teamSize: "1–4", age: "OTA" },
