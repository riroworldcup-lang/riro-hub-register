    ...
    <SiteShell>
      ...
      <header id="top" className="relative min-h-[90vh] flex flex-col justify-center px-4 sm:px-6 py-16 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30 pointer-events-none animate-grid-shift z-[2]"
          style={{
            backgroundImage:
              "linear-gradient(rgba(200,155,60,0.08) 1px, transparent 1px), linear-gradient(90deg, rgba(200,155,60,0.08) 1px, transparent 1px)",
        ...
        <div className="absolute inset-0 opacity-20 pointer-events-none z-[2]">
          <div className="absolute top-0 right-0 w-1/2 h-full border-l border-primary/20 bg-[linear-gradient(45deg,transparent_25%,rgba(200,155,60,0.05)_50%,transparent_75%)] bg-[length:20px_20px]" />
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 grid lg:grid-cols-[1fr_1fr] gap-12 items-center place-items-center">
          <div className="relative text-center">
            ...
            <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black italic tracking-tighter uppercase leading-[0.9] mb-6 animate-slide-up [animation-delay:100ms] drop-shadow-[0_0_25px_rgba(255,255,255,0.15)]">
              RIRO <br />
              <span className="text-primary drop-shadow-[0_0_25px_rgba(200,155,60,0.6)] transition-all duration-500 hover:drop-shadow-[0_0_45px_rgba(200,155,60,0.95)]">World Cup</span> <br />
            ...
            <div className="mb-6 animate-slide-up [animation-delay:280ms] animate-float-y flex justify-center">
              <div className="group relative inline-flex items-center gap-3 px-5 py-3 bg-gradient-to-r from-primary/25 via-primary/10 to-transparent border-l-4 border-primary rounded-r overflow-hidden backdrop-blur-sm transition-all duration-300 hover:from-primary/35 hover:shadow-[0_0_30px_rgba(200,155,60,0.45)]">
            ...
            <div className="flex flex-wrap justify-center gap-4 items-center animate-slide-up [animation-delay:300ms]">
              ...
              <Link to="/competitions" className="group px-6 sm:px-8 py-3 sm:py-4 border border-white/20 font-mono font-bold uppercase tracking-widest text-xs sm:text-sm rounded-sm cursor-pointer transition-all duration-300 hover:border-primary hover:bg-primary/10 hover:shadow-[0_0_25px_rgba(200,155,60,0.35)]">
